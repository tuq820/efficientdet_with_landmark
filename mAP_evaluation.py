        ...
        for index in range(len(dataset)):
            ...
            if boxes.shape[0] > 0:
                ...
                for box_id in range(boxes.shape[0]):
                    ...
                    # box = np.int0(box.cpu().numpy())
                    # print(box.tolist())
                    # print('label:', dataset.label_to_coco_label(label))
                    # print('image_id:', dataset.image_ids[index])
                    image_result = {
...
if __name__ == '__main__':
    ...
    efficientdet.cuda()
    dataset_val = CocoDataset("/disk4t/data/coco/data/coco", set='val2017',
